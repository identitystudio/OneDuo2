 ...
 * 
 * PIPELINE:
 * 1. Extract frames at EXACTLY 1 FPS (non-negotiable)
...
// ========================================
// CONSTANTS - 1 FPS IS NON-NEGOTIABLE
// ========================================
const EXTRACTION_FPS = 1; // EXACTLY 1 FPS - DO NOT CHANGE
...
/**
 * Extract frames at EXACTLY 1 FPS using Replicate
 */
...
async function buildSegmentPdf(
  ...
  const pdfPath = moduleId
    ? `${courseId}/module_${moduleId}/oneduo-1fps${segmentSuffix}.pdf`
    : `${courseId}/oneduo-1fps${segmentSuffix}.pdf`;
...
/F1 24 Tf
50 750 Td
(ONEDUO 1 FPS ARTIFACT${segmentLabel}) Tj
0 -30 Td
/F1 14 Tf
0.2 0.5 0.8 rg
(${cleanTitle}) Tj
...
0 -15 Td
(Frames in this segment: ${frames.length} @ 1 FPS) Tj
0 -15 Td
...
/F1 12 Tf
0 0.6 0.3 rg
(1 FPS PRECISION CAPTURE) Tj
0 0 0 rg
0 -20 Td
/F1 9 Tf
(This artifact captures every visual moment at exactly 1 frame per second.) Tj
0 -12 Td
...
0 -15 Td
/F1 9 Tf
(- Frame Rate: 1 FPS [non-negotiable]) Tj
0 -12 Td
...
0 -10 Td
/F1 9 Tf
([1 FPS precision capture at ${timestampFormatted}]) Tj
0 -20 Td
`;
    }
...
0.4 0.4 0.4 rg
/F1 6 Tf
(OneDuo 1 FPS Artifact | ${courseId.slice(0, 12)}...${segmentLabel}) Tj
0 0 0 rg
ET
`;
